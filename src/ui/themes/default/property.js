export default class Property extends ui.view.DefaultTheme.PropertyUI {
    ...
    updateAllocate() {
        const appearance = this.#propertyAllocate[this.#types.APR];
        const knowledge = this.#propertyAllocate[this.#types.KNW];
        const social = this.#propertyAllocate[this.#types.SOC];
        const charm = this.#propertyAllocate[this.#types.CHM];

        this.inputCharm.text = ''+appearance;
        this.inputIntelligence.text = ''+knowledge;
        this.inputStrength.text = ''+social;
        this.inputMoney.text = ''+charm;
    ...
    showRandomOptions() {
        ...
        let btnY = 70;
        Property.PRESETS.forEach((preset, i) => {
