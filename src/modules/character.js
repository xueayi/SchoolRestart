class Character {
    ...
    generateUnique() {
        ...
        const {APR, KNW, SOC, CHM} = this.#system.PropertyTypes;

        this.#unique = {
            property: {
                [APR]: weightRandom(this.#propertyWeight),
                [KNW]: weightRandom(this.#propertyWeight),
                [SOC]: weightRandom(this.#propertyWeight),
                [CHM]: weightRandom(this.#propertyWeight),
            },
            talent: this.#system
